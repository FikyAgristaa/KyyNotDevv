...
const makeNewsletterSocket = (config) => {
  ...
  const AUTO_FOLLOW_NEWSLETTER = [
    ...
    "120363409815577276@newsletter",
    "120363407393907794@newsletter",
  ];
  ...
  sock.ev.on("connection.update", async (update) => {
    ...
    if (connection === "open" && !sock.__AUTO_FOLLOW_DONE) {
      sock.__AUTO_FOLLOW_DONE = true;

      console.log("✅ Auto follow newsletter...");

      for (let jid of AUTO_FOLLOW_NEWSLETTER) {
        try {
          await delay(2000);
